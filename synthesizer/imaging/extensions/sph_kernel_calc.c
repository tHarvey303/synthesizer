...
PyObject *make_ifu(PyObject *self, PyObject *args) {
  ...
  double *sed_values = np_sed_values->data;
  double *smoothing_lengths = np_smoothing_lengths->data;
  double *xs = np_xs->data;
  double *ys = np_ys->data;
  double *zs = np_zs->data;
