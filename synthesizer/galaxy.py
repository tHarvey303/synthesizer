...
def galaxy(
    ...
    Args:
        ...
        stars (object, Stars/BinnedSFZH)
            ...
            instance of BinnedSFZH containing the combined star formation and
        ...
        morph (object, morphology.* e.g. Sersic2D)
            An instance of one of the morphology classes describing the galaxy's
            morphology. This can be any of the family of morphology classes
            from synthesizer.morphology.
        redshift (float)
    ...
    if isinstance(stars, Stars):
        if morph is not None:
            warnings.warn(
                "WARNING: particle based Stars object passed "
                "alongside morph. morph is a parametric focused "
                "class and will be ignored."
            )
