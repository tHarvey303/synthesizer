 ...
 */
static void spectra_loop_cic_serial(struct grid *grid, Particles *parts,
 ...
 */
#ifdef WITH_OPENMP
static void spectra_loop_cic_omp(struct grid *grid, Particles *parts,
                                 double *spectra, double *part_spectra,
                                 int nthreads) {
 ...
 * @param nthreads: The number of threads to use.
 */
void spectra_loop_cic(struct grid *grid, Particles *parts, double *spectra,
 ...
 * @param spectra: The output array.
 */
static void spectra_loop_ngp_serial(struct grid *grid, Particles *parts,
                                    double *spectra, double *part_spectra) {
 ...
 */
#ifdef WITH_OPENMP
static void spectra_loop_ngp_omp(struct grid *grid, Particles *parts,
                                 double *spectra, double *part_spectra,
                                 int nthreads) {
 ...
 * @param nthreads: The number of threads to use.
 */
void spectra_loop_ngp(struct grid *grid, Particles *parts, double *spectra,
                      double *part_spectra, const int nthreads) {
 ...
 * @param c: speed of light .
 */
static void shifted_spectra_loop_cic_serial(struct grid *grid, Particles *parts,
                                            double *spectra,
                                            double *part_spectra,
                                            const double c) {
 ...
 */
#ifdef WITH_OPENMP
static void shifted_spectra_loop_cic_omp(struct grid *grid, Particles *parts,
                                         double *spectra, double *part_spectra,
 ...
 * @param nthreads: The number of threads to use.
 */
void shifted_spectra_loop_cic(struct grid *grid, Particles *parts,
                              double *spectra, double *part_spectra,
 ...
 * @param c: speed of light.
 */
static void shifted_spectra_loop_ngp_serial(struct grid *grid, Particles *parts,
                                            double *spectra,
                                            double *part_spectra,
                                            const double c) {
 ...
 */
#ifdef WITH_OPENMP
static void shifted_spectra_loop_ngp_omp(struct grid *grid, Particles *parts,
                                         double *spectra, double *part_spectra,
                                         int nthreads, const double c) {
 ...
 * @param nthreads: The number of threads to use.
 */
void shifted_spectra_loop_ngp(struct grid *grid, Particles *parts,
                              double *spectra, double *part_spectra,
                              const int nthreads, const double c) {
