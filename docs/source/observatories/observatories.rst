...
Instrument object encapsulate the properties of different observatories. These can be real observatories, such as JWST, Euclid, or Hubble, or they can be entirely user defined. The instrument object contains the properties of the instrument, such as the wavelength range, resolution, and transmission. 
