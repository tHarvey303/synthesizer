...
In the example linked below, we demonstrate how to initialise galaxy objects of these two different fundamental types, and how the galaxy factory function can handle this for you.
