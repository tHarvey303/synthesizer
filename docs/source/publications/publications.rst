...
You can also find the `technical <technical_publications.rst>`_ and 
`application <application_publications.rst>`_ publications from the Synthesizer project there.
