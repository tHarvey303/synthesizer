...
Usage:
    python profile_time_int_spectra.py --basename test
"""
...
def profile_time_int_spectra(basename):
    ...
    np.savetxt(f"{basename}_integrated_time_prof.txt", times)
...
if __name__ == "__main__":
    ...
    profile_time_int_spectra(args.basename)
