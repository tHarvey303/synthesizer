...
def make_single_alpha_grid(model, ae="+00", bs="bin"):
    ...
    write_attribute(
        out_filename, "metallicities", "Description", "raw abundances"
    )
    write_attribute(
        out_filename, "metallicities", "Units", "dimensionless [log10(Z)]"
    )

    write_data_h5py(
        out_filename, "log10metallicities", data=log10Zs, overwrite=True
    )
    write_attribute(
        out_filename,
        "log10metallicities",
...
def make_full_grid(model, bs="bin"):
    ...
    write_attribute(
        out_filename, "alpha_enhancements", "Units", "dimensionless"
    )
