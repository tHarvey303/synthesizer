...
from write_submission_script import (
    apollo_submission_script,
    cosma7_submission_script,
)


def load_cloudy_parameters(param_file="default_param.yaml", **kwarg_parameters):
    """
...
def make_cloudy_input_grid(output_dir, grid, cloudy_params):
    ...
    ia_ref = grid.get_nearest_index(
        cloudy_params["log10age_ref"], grid.log10ages
    )
