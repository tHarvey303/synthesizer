...
Using the sfzh functionality, we show how to generate a galaxy and produce its
rest-frame spectral energy distribution.
"""
...
# We can also specify different dust emission models for the birth cloud and ISM (diffuse) dust separately:
...
## Generating spectra using an emission model

"""
Below we demonstrate using an `EmissionModel` (see emission model [docs](../emission_model.ipynb)) to generate spectra. Here we use the total model including multiple different individual spectra.
"""
