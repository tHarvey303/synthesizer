...
print(a4)
print(f'gas metallicity: {a4.get_metallicity(): .2g}')
print(f'max d2m: {a4.max_d2m: .2f}')
print(f'current d2m: {a4.get_d2m(): .2f}')

print(f"[O/Fe] = {a4.solar_relative_abundance('O', ref_element='Fe'):.2f}")  # [O/Fe]
# plot_abundance_pattern([a2, a4], [r'Z=0.01', r'Z=0.01; d2m = 0.3'],
#                        show=True, ylim=[-7., -3.])
